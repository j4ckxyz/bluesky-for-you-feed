...
# (Optional) Custom PDS URL if you are not on bsky.social
# Ex: https://pds.example.com
PDS_URL: str = os.environ.get('PDS_URL')
...
def main():
    client = Client(PDS_URL) if PDS_URL else Client()
