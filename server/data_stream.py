...
def run(name, operations_callback, stream_stop_event=None, subscription_endpoint=None):
    while stream_stop_event is None or not stream_stop_event.is_set():
        try:
            _run(name, operations_callback, stream_stop_event, subscription_endpoint)
...
def _run(name, operations_callback, stream_stop_event=None, subscription_endpoint=None):
    ...
    if subscription_endpoint:
        client = FirehoseSubscribeReposClient(params, base_uri=subscription_endpoint)
    else:
